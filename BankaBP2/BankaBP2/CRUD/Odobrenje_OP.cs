...
{
   public class Odobrenje_OP
    {
        //CRUD
        public void AddZir(int id,int ris)
        {
            if (id != null && ris!=null)
            {
                using (var db = new Model1Container())
                {
                    Odobrenje k = new Odobrenje();
                    k.OdlukaID_ODLUKE = id;
                    k.RISKID_KOMISIJE = ris;
        ...
        //Update
        public void UpdateZir(int id, int ris)
        {

            using (var db = new Model1Container())
            {
                var k = db.Odobrenjes.SingleOrDefault(n => n.OdlukaID_ODLUKE == id);
        ...
        //Delete
        public void DeleteKli(Odobrenje r)
        {
