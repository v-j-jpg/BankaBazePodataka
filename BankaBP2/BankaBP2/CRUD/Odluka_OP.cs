...
{
  public  class Odluka_OP
    {
        //CRUD
        public void AddZir(string odobreno, string DAT_OD)
        {
            if (odobreno != null)
            {
        ...
        //Update
        public void UpdateZir(int id,string odobreno, string DAT_OD)
        {

            using (var db = new Model1Container())
            {
                var k = db.Odlukas.SingleOrDefault(n => n.ID_ODLUKE == id);
        ...
        //Delete
        public void DeleteKli(Odluka r)
        {
